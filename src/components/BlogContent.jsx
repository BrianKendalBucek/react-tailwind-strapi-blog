      ...
      <div className='max-w-[1240px] mx-auto'>
        ...
        md:gap-x-8 sm:gap-y-8 ss:gap-y-8 px-4 sm:pt-20 md:mt-0 ss:pt-20 text-black'>
          ...
          <div className='col-span-2'>
            ...
            {/* <div className='pt-5'><ReactMarkdown className='line-break'>{blog.attributes.blogContent[0].children[0].text}</ReactMarkdown></div> */}
            <div className='pt-5'><p>{blog.attributes.blogContent[0].children[0].text}</p></div>
          </div>
